...
const FilteredList = ({navigation, route}) => {
  ...
  const ingredients =
    'MeatCube,GroundMeat,Turkey,Kofta,Liver,Susage,MeatShank,Escalop,Checkin,CheckinFillet,Kidney,MeatSteak,CheckinWings,CheckinLegs,Shawrma,Fish,Seafood,Crabs,Shrimp,FishFillet,Calamari,Rice,Pasta,Frik,Potatos,Eggplants,Zucchini,Peas,Spinach,Cauliflower,Ocra,Molokhia,Vegetarian,Keto,Diet,Cabbage'
      .split(',')
      .map(e => 'has' + e);
